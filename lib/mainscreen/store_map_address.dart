...
class StoreMapAddress extends StatefulWidget {
  @override
  _StoreMapAddressState createState() => _StoreMapAddressState();
}

class _StoreMapAddressState extends State<StoreMapAddress> {
